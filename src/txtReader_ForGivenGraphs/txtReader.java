...
public class txtReader{
    public static void main(String[] args) throws FileNotFoundException {
        ...
        createGraphFromTxt_Matrix(txtPath).printGraph();
        //System.out.println(createGraphFromTxt(txtPath).neighbours(45));
    }

    public static GraphMatrix createGraphFromTxt_Matrix(String txt) throws FileNotFoundException {
...
//                    System.out.println(graph.hasEdge(firstVert, secondVert));
    ...
    public static GraphList createGraphFromTxt_List(String txt) throws FileNotFoundException {
        File file = new File(txt);
        Scanner scanner = new Scanner(file);
